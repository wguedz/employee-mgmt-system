		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeemgmtcomemployeemgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeemgmtcomemployeemgmt-display": {
								"semanticObject": "employeemgmtcomemployeemgmt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employee.mgmt.com.employeemgmt",
									"url": sap.ui.require.toUrl("employee/mgmt/com/employeemgmt")
								}
							}
						}
					}
